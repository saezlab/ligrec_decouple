...
### Run CRC
bash bash_scripts/large_bash.sh $compscript crc "data/input/comparison/crc_data/crc_korean_form.rds" # "data/input/comparison/comparison/crc_data/crc_korean_form.RDS"
