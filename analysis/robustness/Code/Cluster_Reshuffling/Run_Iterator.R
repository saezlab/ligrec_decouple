...
# 1. Setup ---------------------------------------------------------------------
{
  ...
  source("analysis/robustness/Code/Cluster_Reshuffling/CR_Shuffler_Functions.R")
  # Define functions for subsetting cluster annotations, instead of reshuffling
  source("analysis/robustness/Code/Cluster_Reshuffling/CR_Subsetter_Functions.R")
  # Define functions for iterating LIANA on all the reshuffled clusters
  source("analysis/robustness/Code/Cluster_Reshuffling/CR_LIANA_Functions.R")
