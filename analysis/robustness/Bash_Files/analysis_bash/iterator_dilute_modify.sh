...
/net/data.isilon/ag-saez/bq_pburmedi/SOFTWARE/miniconda3/envs/liana_env/bin/Rscript Code/Analysis_Scripts/Resources_Run_Iterator.R TRUE "variable" 500 $SLURM_JOBID FALSE 
